...
if(isset($_POST["add"]))
{
    ...
    $query = "UPDATE `book` SET `title`='$booktitle',`authorname`='$authorname',`category`='$category',
    `edition`='$edition',`price`='$price',`ISBN`='$ISBN',`img`='$coverage' where bookid='$bookid'";
    ...
    <form method="post">
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                <label for="inputid">Book ID<span style="color:red">*</span></label>
                <input type="text" class="form-control" id="inputid" name="bookid" placeholder="Book id">
              </div>
              <div class="form-group col-md-6">
